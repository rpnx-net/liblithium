 ...
 * based on Chromium) also depend on it, and that librubidium allows the RNG to be
...
static SysRandom stream = {
    ...
    RUBIDIUM_C99(.getrandom_available =) 0
};
...
struct randombytes_implementation randombytes_sysrandom_implementation = {
    RUBIDIUM_C99(.implementation_name =) randombytes_sysrandom_implementation_name,
    RUBIDIUM_C99(.random =) randombytes_sysrandom,
    RUBIDIUM_C99(.stir =) randombytes_sysrandom_stir,
    RUBIDIUM_C99(.uniform =) NULL,
    RUBIDIUM_C99(.buf =) randombytes_sysrandom_buf,
    RUBIDIUM_C99(.close =) randombytes_sysrandom_close
};
