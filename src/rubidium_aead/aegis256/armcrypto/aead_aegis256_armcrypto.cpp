...
static inline void
rubidium_aead_aegis256_update(uint8x16_t *const state, const uint8x16_t data)
{
...
static void
rubidium_aead_aegis256_init(const unsigned char *key, const unsigned char *nonce,
...
static void
rubidium_aead_aegis256_mac(unsigned char *mac, std::size_t adlen,
                         std::size_t mlen, uint8x16_t *const state)
{
    uint8x16_t tmp;
    int        i;
...
static void
rubidium_aead_aegis256_enc(unsigned char *const dst,
...
static void
rubidium_aead_aegis256_dec(unsigned char *const dst,
                         const unsigned char *const src,
                         uint8x16_t *const state)
{
    uint8x16_t msg;
